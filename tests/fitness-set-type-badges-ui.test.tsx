...
import type { FitnessLiveSession, FitnessSessionSetType } from '@/features/fitness/fitnessTypes'

function makeSet(setNumber: number, setType: FitnessSessionSetType) {
  return {
    id: `set-${setType}`,
...
describe('fitness set type badges', () => {
  ...
  test('shows readable set type badges in workout history detail', () => {
    ...
    expect(container.textContent).toContain('100 kg × 10 · RIR 0 · Do zlyhania')
  })
})
