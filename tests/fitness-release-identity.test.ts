...
describe('StingFit V1 release identity', () => {
  ...
  test('reports StingFit V3 release version across app metadata', () => {
    ...
    expect(packageLock.version).toBe('3.0.1')
    expect(packageLock.packages['']?.version).toBe('3.0.1')
    expect(tauriConfig.productName).toBe('StingFit')
    expect(tauriConfig.version).toBe('3.0.1')
