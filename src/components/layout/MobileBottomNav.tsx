...
const MOBILE_NAV_ITEMS: MobileNavItem[] = [
	...
	{ label: "Kotúče", path: "/plates", icon: Calculator },
			...
			<div className="mx-auto grid max-w-xl grid-cols-6 items-end gap-1">
				{MOBILE_NAV_ITEMS.map((item) => {
					...
					return (
						<NavLink
							...
							className={({ isActive }) =>
								cn(
									...
									item.primary
										? "-mt-5 min-h-16 scale-105 rounded-3xl border border-fitness-yellow bg-fitness-yellow text-black shadow-[0_0_28px_rgba(255,255,0,0.28)]"
										: "",
						...
						>
							<Icon
								className={cn("shrink-0", item.primary ? "size-5" : "size-4")}
							/>
